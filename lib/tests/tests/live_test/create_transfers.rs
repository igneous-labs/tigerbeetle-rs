...
use tigerbeetle_unofficial::{
    data_model::{
        transfer::{
            ...
            HasTransferAmt, HasTransferFlags,
        },
...
/// - an account with ID 1 that can debited by 1 on ledger 700 (just run the tigerbeetle repl example)
/// - an account with ID 2 that can be credited by 1 on ledger 700 (just run the tigerbeetle repl example)
#[tokio::test]
